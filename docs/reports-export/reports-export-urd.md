...
* **Màn cài đặt chỉ đổi được thứ an toàn**: biểu tượng được bật trong danh sách máy chủ cho phép, khung thời gian biểu đồ, lịch buổi tối và múi giờ, hiệu chỉnh tay cầm, rung, micro và nút giữ để nói, giọng đọc, mặc định báo cáo. *(Mục **hạn giữ nhật ký** đã bỏ 2026-08-29 — xem OQ-2.)*
...
| UN-018 | Người chơi | Muốn đổi một thứ vô hại: thêm biểu tượng, dời khung giờ, tắt rung, đổi nút giữ để nói | Đổi được ngay trong sản phẩm, **không phải vào máy chủ sửa tệp** | Màn cài đặt đổi được: biểu tượng trong danh sách máy chủ cho phép, khung thời gian biểu đồ, lịch buổi tối và múi giờ, hiệu chỉnh tay cầm, rung, micro và nút giữ để nói, giọng đọc, mặc định báo cáo *(bỏ **hạn giữ nhật ký** 2026-08-29)* | High | Observed: `phase-13` (danh sách safe preferences), trừ mục đã bỏ ở OQ-2 |
...
| ~~Hạn giữ nhật ký mâu thuẫn với "nhật ký giữ vô hạn"~~ | — | **Đã loại bỏ 2026-08-29** (OQ-2): mục *hạn giữ nhật ký* bị bỏ khỏi màn cài đặt, nên **không tồn tại cơ chế tự xoá nào** để vô tình bật | J6 / UN-018 |
...
* [x] OQ-2: **Mâu thuẫn xuyên tài liệu** giữa mục *hạn giữ nhật ký* và ràng buộc **giữ vô hạn** của `daily-journal` — **Resolved 2026-08-29: bỏ hẳn mục *hạn giữ nhật ký* khỏi màn cài đặt.** Lý do: nó mâu thuẫn với **hai** quyết định đã chốt (`daily-journal` Mục 7 · `voice-journal` OQ-5); ~20 phiên/tháng nên chữ, ảnh và giọng nói đều không đáng kể; thứ duy nhất phình thật là **tape**, mà tape nay thuộc `order-execution` nên hạn giữ tape là cấu hình của tape. Thay thế: **cảnh báo dung lượng (UN-017) + xoá thủ công**. Đóng luôn OQ-11 của `daily-journal`. Phương án "giữ, mặc định tắt" đã bị loại vì nó giữ nguyên chi phí giao diện, giữ mâu thuẫn ở dạng ngủ đông, và lần duy nhất nó được bật chính là lần mất dữ liệu.
