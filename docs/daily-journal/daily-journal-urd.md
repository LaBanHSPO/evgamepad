...
* [x] OQ-11: **Mâu thuẫn xuyên tài liệu** với mục *hạn giữ nhật ký* của `reports-export` — **Resolved 2026-08-29: bỏ hẳn mục đó.** Ràng buộc "giữ vô hạn, không bao giờ tự xoá thứ gì" ở Mục 7 đứng nguyên; **không tồn tại cơ chế tự xoá nào trong sản phẩm**. Thay thế: cảnh báo dung lượng + xoá thủ công. Đóng luôn OQ-2 của `reports-export`.
